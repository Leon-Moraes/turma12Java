programa
{
	...
	
	{
		...
		verdadeiro,falso, verdadeiro, falso, falso, verdadeiro, verdadeiro, verdadeiro, falso, falso,falso, falso, verdadeiro,verdadeiro}
		cadeia parar
				...
				para( x = 0; x < limite; x++){
					...
					se(parar == "S" ou parar == "s"){
						...
						para(x = 0; x < limite; x++){
						escreva("G5 - ",x+1,"\t",nome[x],"\t",mail[x],"\t\t\t",entrega[x],"\t",nota[x],"\n")
						}
